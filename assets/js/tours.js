...
function tourSelected(tourId) {
    //constiables to get the html elements that will host the dynamic content
    const tourDetailsDiv = document.getElementById("tourDetails");
    const h2PointA = document.getElementById("h2-pointA");
    const h2PointB = document.getElementById("h2-pointB");
    const h2PointC = document.getElementById("h2-pointC");
    const pPointA = document.getElementById("p-pointA");
    const pPointB = document.getElementById("p-pointB");
    const pPointC = document.getElementById("p-pointC");
    const imgPointA = document.getElementById("img-pointA");
    const imgPointB = document.getElementById("img-pointB");
    const imgPointC = document.getElementById("img-pointC");
    const aPointA = document.getElementById("a-pointA");
    const aPointB = document.getElementById("a-pointB");
    const aPointC = document.getElementById("a-pointC");
    ...
    if (tourId === "tour1") {
        ...
        pPointA.innerHTML = "Crossing the Third Bridge, we arrive at the Penha Convent. The souvenir shop at the top of the mountain, and other shops near the entrance proton, sell the most constied religious products.In Vila Velha it is also possible to find the most constied items of Espírito Santo, such as clothes, products from the cinnamon-green culture and even artisanal gastronomic products.";
